/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file ./../../.env --env-interface CloudflareBindings` (hash: d5bbb7df67bf4481457fb2205709e125)
// Runtime types generated with workerd@1.20251210.0 2024-12-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CollaborationDO";
	}
	interface Env {
		...
		ZERO_QUERY_URL: string;
		ZERO_MUTATE_URL: string;
		ZERO_QUERY_FORWARD_COOKIES: string;
		ZERO_MUTATE_FORWARD_COOKIES: string;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		COLLABORATION_DO: DurableObjectNamespace<import("./src/index").CollaborationDO>;
